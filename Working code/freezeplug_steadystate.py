...
# CSV filenames
path_name = f"/Users/Jesper/Documents/MEP/Code/Working code/Figures/freeze_plug_3/90deg/w=5/freezing/"
suffix = f"freeze_plug_{phi}deg_tau={tau}_N={Nx}x{Ny}.png"
csv_path = f"/Users/Jesper/Documents/MEP/Code/Working code/sim_data/freeze_plug_3/90deg/w=5/freezing/"
...
def initialize(g):
    ...
    path2 = "_freeze_plug_90deg_tau=0.5143_N=300x200_t=12000.0.csv"
