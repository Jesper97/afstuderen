...
import pandas as pd
import streaming_funcs_plug_gc as str
import sys
import time
...
# CSV filenames
path_name = f"/home/jhsvanwinden/google_cloud/Figures/freeze_plug_2/60deg/w=001/freezing/"
suffix = f"freeze_plug_{phi}deg_tau={tau}_N={Nx}x{Ny}.png"
csv_path = f"/home/jhsvanwinden/google_cloud/sim_data/freeze_plug_2/60deg/w=001/freezing/"
